...
export const triviaData: { [key: string]: Question[] } = {
  'general-trivia': [
    ...
    {
      id: 42,
      question: 'Which of these is not considered a capital city in World of Warcraft?',
  ...
  'state-trivia': [
    ...
    },
    {
      ...
      correctAnswer: "Colorado",
      explanation: "WY is 3,105 ft (946m); AK is 3,105 ft (946m); MT is 1,804 ft (550m)."
    },
    {
      id: 890,
    ...
    {
      id: 1321,
      question: "The Gateway Arch is found in this state.",
      options: ["Missouri", "Illinois", "Kansas", "Oklahoma"],
      correctAnswer: "Missouri",
      explanation: "At 630 ft (192m) tall and wide, it is the tallest man-made monument in the Western Hemisphere."
    },
    {
      id: 1322,
      question: "The biggest shoe manufacturer in the world (by revenue) is located in this state.",
      options: ["Missouri", "Tennessee", "Oklahoma", "New York"],
      correctAnswer: "Missouri",
      explanation: "Caleres, which formerly operated as the Brown Shoe Company, owns dozens of brands including Dr Scholl's, LifeStride and Sam Edelman. But they were known for Buster Brown Shoes with the popular comic strip character of Buster Brown and his dog Tige."
    },
    {
      id: 1323,
    ...
    {
      id: 1416,
      question: "This is the only state with an official state meal is _____, and includes chicken fried steak, barbecue pork, sausage and gravy.",
    ...
    },
    {
      ...
      correctAnswer: "Utah",
      explanation: "The four largest rock arches are all in China (and were NOT made with child labor)."
    },
    {
      id: 1487,
  ...
  'government-trivia': [
    ...
    {
      id: 923,
      question: "He was the 8th president and was the first US president to be born a citizen of the US. (All prior ones were British subjects)",
      options: [
        "Martin Van Buren",
        "Abraham Lincoln",
        "John Adams",
